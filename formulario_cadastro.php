...
if(isset($_POST['submit']))
{
       ...
       print_r('<br>');                
        ...
        $result = mysqli_query($conexao, "INSERT INTO usuarios(id,nome,email,cpf,cnpj,dataNasc,senha,cidade,estado,logradouro,numeroR,bairro,cep) 
            VALUES ('$idusuarios','$nome','$email','$cpf','$cnpj','$dataNasc','$senha','$cidade','$estado','$logradouro','$numeroR','$bairro','$cep')");
